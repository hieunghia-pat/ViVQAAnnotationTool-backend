...
public enum UserRole {
    ...
    ADMIN(Sets.newHashSet(ADMIN_READ, ADMIN_WRITE, ANNOTATOR_READ, ANNOTATOR_WRITE, IMAGE_READ, IMAGE_WRITE,
            ...
            USER_AGREEMENT_READ, GUIDELINE_READ, GUIDELINE_WRITE)),
    ANNOTATOR(Sets.newHashSet(ANNOTATOR_READ, IMAGE_READ, ANNOTATION_READ, ANNOTATION_WRITE, SUBSET_READ, GUIDELINE_READ, ASSIGNMENT_READ));
