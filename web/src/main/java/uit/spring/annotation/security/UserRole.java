...
public enum UserRole {
    ...
    ADMIN(Sets.newHashSet(ADMIN_READ, ADMIN_WRITE, ANNOTATOR_READ, ANNOTATOR_WRITE, IMAGE_READ, IMAGE_WRITE, ANNOTATION_READ, ANNOTATION_WRITE, SUBSET_READ, SUBSET_WRITE)),
